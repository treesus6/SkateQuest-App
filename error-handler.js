...
(function() {
    ...
    function log(message, type = 'info', data = null) {
        ...
        console[type === 'error' ? 'error' : 'log'](`[SkateQuest ${type.toUpperCase()}] ${message}`, data || '');
    ...
    window.retryAsync = async function(fn, retries = CONFIG.MAX_RETRIES, delay = CONFIG.RETRY_DELAY) {
