...
(function() {
    ...
    const PortalDimensionSpot = {
        ...
        init: async function() {
            ...
            if (window.firebaseInstances?.auth && window.firebaseInstances?.signInAnonymously && !window.firebaseInstances.auth.currentUser) {
                try { await window.firebaseInstances.signInAnonymously(window.firebaseInstances.auth); } catch (e) { console.debug('Anon sign-in failed (already signed in?)', e); }
            }
        ...
        addMarker: function() {
            ...
            this.marker = L.marker(
                [this.config.location.latitude, this.config.location.longitude],
                { 
                    icon: portalIcon,
        ...
        trackClick: async function() {
            ...
            if (window.firebaseInstances && window.firebaseInstances.db && window.firebaseInstances.functions && window.firebaseInstances.httpsCallable) {
                try {
                    ...
                    if (window.firebaseInstances?.auth && window.firebaseInstances?.signInAnonymously && !window.firebaseInstances.auth.currentUser) {
                        try { await window.firebaseInstances.signInAnonymously(window.firebaseInstances.auth); } catch (_) {}
                    }
